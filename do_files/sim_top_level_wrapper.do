...
add wave -decimal sim:/dut/top_level_ins/perm_input_inv
add wave -unsigned sim:/dut/top_level_ins/shift_inv
add wave -decimal sim:/dut/top_level_ins/perm_output_inv
...
add wave -unsigned sim:/dut/top_level_ins/gen_cnbs(0)/cnbs_ins/addr_msg_ram_write_reg
